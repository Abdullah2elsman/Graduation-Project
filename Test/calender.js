...
const closeButton = document.querySelector(".closebtn-calendar");
console.log(closeButton);
const calendarSidebar = document.querySelector('.calender-sidebar');
let calendarSidebarFlag = false;

[openCalendarButton, closeButton].forEach(button => {
